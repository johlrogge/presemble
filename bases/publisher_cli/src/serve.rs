...
const INJECT: &str = concat!(
    ...
    ".presemble-suggestion{background:#fef9e7;border:2px dashed #d4a853;border-radius:6px;padding:0.5rem 1rem;color:#8b7335;font-style:italic;opacity:0.85;position:relative;}",
